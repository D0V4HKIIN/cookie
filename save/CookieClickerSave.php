			...
			for(i = 0; i < farm_nb; i++){
				...
				setInterval(
					function cookies_every_sec_from_farm(){
						...
						document.getElementById("cookies_show").innerHTML = cookies_nb;}, 1000);};
				...
				document.getElementById("cookies_per_sec_show").innerHTML = cookies_per_sec;
					setInterval(
						function cookies_every_sec_from_usine(){
							cookies_nb = cookies_nb + 1;
							document.getElementById("cookies_show").innerHTML = cookies_nb;}, 100);};
			for(i = 0; i < god_nb; i++){
...
<marquee id="mar1" direction="up"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"><img width="5%" src="cookie.jpg"></marquee>
</body>
</html>